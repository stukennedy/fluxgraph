...
export class SinkConfigurations {
     ...
     * Console logger sink
     */
    static consoleLogger(name = 'GraphOutput') {
        return {
     ...
     */
    static websocketBroadcaster(url) {
        return {
            id: `sink-ws-${Date.now()}`,
            type: 'sink',
     ...
     * HTTP webhook
     */
    static httpWebhook(url, method = 'POST') {
        return {

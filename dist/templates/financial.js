...
export function createSpendingMonitor(config) {
    ...
    return GraphBuilder.create("Spending Monitor")
        ...
        .nodes(nodes.manual("input"), nodes.filter("expenses", {
 ...
 */
export function createTransactionCategorizer() {
    return GraphBuilder.create("Transaction Categorizer")
        ...
        .nodes(nodes.manual("input"), nodes.transform("categorize", {
